      ...
      {contents.map((content) => {
        return (
          <Link key={content.id} href={`/blog/detail/${content.id}`}>
            <div className="mx-3 mb-3 flex h-52 flex-col justify-between overflow-hidden rounded-xl border transition-all duration-500 md:mb-6 md:h-64 lg:hover:scale-105 ">
